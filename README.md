...
**Прочие улучшения v6.7:**
- 🔥 **Установка через git+DKMS** — больше никаких подвисаний на `add-apt-repository`. Работает на любой Ubuntu/Debian
- 🔥 **Авто-очистка PPA остатков** при обновлении со старых версий
- 🔥 **Авто-фикс DNS** если резолв github.com не работает (применяется Cloudflare/Google/Quad9)
- ✅ Health-check + auto-failover для Warp (systemd timer)
- ✅ Selective Warp по клиентам — выбор кого через Cloudflare
- ✅ MTU убран из клиентских конфигов (PMTUD автоматически подбирает)
- ✅ Точечный rp_filter (eth0 защищён, warp0/awg0 в loose)
- ✅ Warp без wg-quick — не ломает SSH через fwmark
