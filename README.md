...
**AWG Toolza: LucX Edition v6.8.8** · MIT License

*Доработки от alexeylcp (интеграция Xray, Hysteria2 и др.)* · **PolyForm Noncommercial 1.0.0**

## ☕ Поддержать автора LucX Edition
Разработка форка, интеграция Xray и других механизмов обфускации занимает много времени.
Если проект оказался полезен, вы можете поддержать меня:
- [GitHub Sponsors](https://github.com/sponsors/AlexeyLCP)
- [Boosty](https://boosty.to/alexeylcp)
- USDT (TRC20): `TWXrayTunnelDonationPlaceholderAddress` (замените на ваш кошелёк)
